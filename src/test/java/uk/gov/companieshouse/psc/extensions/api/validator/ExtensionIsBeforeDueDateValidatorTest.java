...
class ExtensionIsBeforeDueDateValidatorTest {
    ...
    private ExtensionIsBeforeDueDateValidator validator;
    ...
    @BeforeEach
    void setUp() {
        validator = new ExtensionIsBeforeDueDateValidator(pscLookupService, logger);
